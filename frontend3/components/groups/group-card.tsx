...
// Define the Group interface to ensure type safety
...
export default function GroupCard({ group }: GroupCardProps) {
  return (
    <Link href={`/groups/${group.id}`}>
      <div className="glass-card glass-interactive rounded-2xl p-5 flex flex-col h-full gap-4 transition-all hover:shadow-xl hover:-translate-y-1 bg-white/70 backdrop-blur-md border border-white/30">
